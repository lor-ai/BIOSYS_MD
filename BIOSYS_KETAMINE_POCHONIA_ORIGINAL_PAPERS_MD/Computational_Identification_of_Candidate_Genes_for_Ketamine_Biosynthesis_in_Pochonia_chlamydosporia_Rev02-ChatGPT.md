...
**Rev02 - sequence-grounded update after Pc123 Ensembl remap**
...
The most defensible current model is a minimal-deviation or partially distributed pathway hypothesis. Under that model, aromatic chlorination can be borrowed from established halogenated secondary metabolism, while ketamine-specific chemistry would require additional steps for carbon-skeleton construction, aryl-cyclohexanone coupling, transamination, and N-methylation. Among these, the coupling step remains the largest biochemical uncertainty and should be treated as the primary innovation to test.
...
| III | Late-stage and modular heterologous sufficiency tests | Express finishing-enzyme combinations and feed plausible intermediates; separately test whether the grounded Rdc2-containing locus can supply compatible chlorinated precursor chemistry | Production of diagnostic intermediates or ketamine-consistent products in a heterologous host |
