# Computational Reverse-Pathway Analysis of Candidate Enzymatic Logic for Ketamine Biosynthesis in *Pochonia chlamydosporia*

**Rev04 - title, abstract, and cross-reference alignment after mechanistic pathway correction**
...
Ketamine has been reported from bioactive fractions of cultures of the nematophagous fungus *Pochonia chlamydosporia*, motivating a reverse-pathway analysis of how this species could assemble a chlorinated arylcyclohexylamine. Earlier drafts of the present manuscript proposed a dedicated five-gene ketamine biosynthetic cluster on Scaffold 14. Here, that proposal is revised using the public Pc123 Ensembl annotation set (PcB1v2; GCA_000411695.2) together with the improved PcB1v4 assembly (GCA_000411695.4). We reconciled draft-specific candidate identifiers with public gene models, extracted the corresponding annotated protein, CDS, and cDNA records, and mapped validated intervals from PcB1v2 to PcB1v4.
...
Taken together with the reverse-engineered pathway model in Figure 1, the most defensible interpretation is a hypothesis-driven, partially distributed pathway architecture. Aromatic chlorination is biologically plausible in *P. chlamydosporia*, but the ketamine-specific steps - especially aryl-cyclohexanone coupling and the post-coupling oxidation/amination sequence - remain unresolved. Accordingly, the experimental proposal is revised from immediate full-cluster reconstruction in *Saccharomyces cerevisiae* to the gated validation program summarized in Table 3: orthogonal compound confirmation, isotope incorporation, native genetic linkage, modular heterologous testing, and only then any larger pathway reconstruction.
...
Once the public annotation layer was introduced, the best sequence-grounded result shifted away from Scaffold 14 and toward a different, biologically coherent locus. This is the central correction in Rev04: the paper now reports a validated comparator locus that constrains pathway logic rather than an unsupported dedicated ketamine cluster.
...
The revised genomic evidence simultaneously strengthens and narrows different aspects of the original argument. It strengthens biological plausibility for chlorinated aromatic chemistry because the Pc123 annotation now grounds a real Rdc2/P450/paired-PKS locus that fits known fungal halogenated secondary-metabolism logic. It narrows the paper's strongest claim to that grounded comparator-locus result, while Figure 1 shifts the pathway discussion to a reverse-engineered model in which the key unresolved step is aryl-cyclohexanone C-C bond formation rather than direct late transamination of a simple cyclohexanone.
...
The original heterologous-expression plan described immediate reconstruction of a five-gene, ~32 kb Scaffold 14 cassette in *Saccharomyces cerevisiae*. That is no longer justified by the sequence-grounded evidence. Guided by the distributed-candidate picture in Table 2 and the post-oxidation amination model in Figure 1, the experimental program should instead proceed through explicit gates.
...
Rev04 replaces an unsupported dedicated-cluster narrative with a sequence-grounded genomic result and a mechanistically corrected pathway model. Pc123 clearly encodes halogenated secondary-metabolism machinery, and the scaffold1640 / AOSW04000009.1 comparator locus provides a concrete anchor for aromatic chlorination chemistry in *P. chlamydosporia*. What remains unresolved is whether that chemistry feeds into a ketamine pathway and, if so, how the coupling, post-coupling oxidation, amination, and N-methylation steps are organized. The paper is therefore strongest as a reverse-pathway and experimental-prioritization manuscript rather than as a claim of pathway discovery.
...
- Language to avoid: 'we identified the ketamine biosynthetic genes', 'a unique five-gene cluster on Scaffold 14', or wording that implies direct conversion of a simple arylcyclohexanone to ketamine by aminotransferase alone.